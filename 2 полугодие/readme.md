...
Условия задачи: прямоугольный, равнобедренный, катет 15, левый катет треугольника параллелен оси OY, соответственно прямой угол смотрит в левый верхний угол
Решение:
for i in range(1,100):
    chislo=''
    num=(bin(i)[2:])
...
Условия задачи:
Во всех четырёхзначных числах из семизначной системы счисления, среди множества этих значений найти количество значений, которые отвечаютследующим требованиям - содержит в себе одну четвёрку, рядом с четвёркой не стоит чётное число.
```
